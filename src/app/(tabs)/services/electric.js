    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.iconCircle}>
          <Ionicons name="flash" size={48} color="#D97706" />
        </View>
        <Text style={styles.title}>Electricity</Text>
        <Text style={styles.subtitle}>This service is coming soon!</Text>
        <Text style={styles.description}>
          Pay your electricity bills for AEDC, EKEDC, IKEDC, PHEDC and more directly from your wallet.
        </Text>
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 96, height: 96, borderRadius: 48, backgroundColor: '#FFFBEB', alignItems: 'center', justifyContent: 'center', marginBottom: 24 },
